...
INTEGER :: I,J,K,NQT,I1,I2,J1,J2,K1,K2,ITM,ITM1,IQ,IQ2,IQ3,IQQ,IND,IND2,II1,II2,JJ1,JJ2,KK1,KK2, &
           IC,Y_INDEX,Z_INDEX,ELEM_INDEX,PART_INDEX,VELO_INDEX,PROP_INDEX,REAC_INDEX,MATL_INDEX,NOM,IIO,JJO,KKO,I_INC,&
           J_INC,DEBUG,IERROR,IFACT,JFACT,KFACT,NX,NY,NZ,KTS,NTSL,ICO
...
QUANTITY_LOOP: DO IQ=1,NQT
   ...
   IF (.NOT.AGL_TERRAIN_SLICE) THEN
      DO K=KK1,KK2
         DO J=JJ1,JJ2
            DO I=II1,II2
               QUANTITY(I,J,K) = GAS_PHASE_OUTPUT(T,DT,NM,I,J,K,IND,IND2,Y_INDEX,Z_INDEX,ELEM_INDEX,PART_INDEX,VELO_INDEX,0,&
   ...
   ELSE
      ...
      DO I=II1,II2
         DO J=JJ1,JJ2
            ...
            QUANTITY(I,J,K1) = GAS_PHASE_OUTPUT(T,DT,NM,I,J,KTS,IND,IND2,Y_INDEX,Z_INDEX,ELEM_INDEX,PART_INDEX,VELO_INDEX,0,0,0,0)
         ENDDO
      ENDDO
   ENDIF
...
REAL(EB) :: H_TC,TMP_TC,RE_D,NUSSELT,VEL,K_G,MU_G,COSTHETA,FAC,&
            ...
            UVW,UODX,VODY,WODZ,XHAT,ZHAT,BBF,GAMMA_LOC,VC,VOL,PHI,GAS_PHASE_OUTPUT_CC,PRES,PRES_OUT,&
...
IND_SELECT: SELECT CASE(IND)
   ...
   CASE(146)  ! EQUILIBRIUM TEMPERATURE
      ZZ_GET(1:N_TRACKED_SPECIES) = ZZ(II,JJ,KK,1:N_TRACKED_SPECIES)
      PRES = PBAR(KK,PRESSURE_ZONE(II,JJ,KK)) + RHO(II,JJ,KK)*(H(II,JJ,KK)-KRES(II,JJ,KK))
      GAS_PHASE_OUTPUT_RES = 0._EB
      CALL EQUILIBRATE(ZZ_GET,TMP(II,JJ,KK),PRES,GAS_PHASE_OUTPUT_RES,PRES_OUT,1)
      GAS_PHASE_OUTPUT_RES = GAS_PHASE_OUTPUT_RES - TMPM

   CASE(147)  ! INITIAL MIXED ZONE TEMPERATURE
      GAS_PHASE_OUTPUT_RES = INITIAL_TMP_MIX(II,JJ,KK) - TMPM

   CASE(148)  ! FINAL MIXED ZONE TEMPERATURE
      GAS_PHASE_OUTPUT_RES = FINAL_TMP_MIX(II,JJ,KK) - TMPM   

   CASE(149)  ! MODIFIED ZETA
      GAS_PHASE_OUTPUT_RES = 1.0_EB - MOD_ZETA(II,JJ,KK) 
