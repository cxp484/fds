...
USE FIRE, ONLY: CALC_ADIABATIC_FLAME_TEMPERATURE
...
IND_SELECT: SELECT CASE(IND)
   ...
   CASE(146)  ! ADIABATIC FLAME TEMPERATURE
      ZZ_GET(1:N_TRACKED_SPECIES) = ZZ(II,JJ,KK,1:N_TRACKED_SPECIES)
      GAS_PHASE_OUTPUT_RES = 0._EB
      CAP_LEAN = .FALSE.
      CALL CALC_ADIABATIC_FLAME_TEMPERATURE(ZZ_GET(1:N_TRACKED_SPECIES),TMP(II,JJ,KK),CAP_LEAN,GAS_PHASE_OUTPUT_RES)
      GAS_PHASE_OUTPUT_RES = GAS_PHASE_OUTPUT_RES - TMPM

   CASE(147)  ! MIXED ZONE TEMPERATURE
      ZZ_GET(1:N_TRACKED_SPECIES) = ZZ(II,JJ,KK,1:N_TRACKED_SPECIES)
      GAS_PHASE_OUTPUT_RES = TMP_MIX(II,JJ,KK) - TMPM
