...
USE CHEMCONS, ONLY: ODE_MIN_ATOL,CVODE_ORDER,EQUIV_RATIO_CHECK, MIN_EQUIV_RATIO, MAX_EQUIV_RATIO, DO_CHEM_LOAD_BALANCE, &
                FUEL_ID_FOR_AFT,USE_MIXED_ZN_AFT_TMP,DT_RATIO_FOR_Q_CAP,AFT_ENABLE_TMP,DO_Q_CAPPING
REAL(EB) :: ODE_REL_ERROR
CHARACTER(LABEL_LENGTH) :: RAMP_ZETA_0='null'
CHARACTER(LABEL_LENGTH) :: MIXED_ZN_TMP='CELL TMP'
NAMELIST /COMB/ AFT_ENABLE_TMP,CHECK_REALIZABILITY,COMPUTE_ADIABATIC_FLAME_TEMPERATURE,CVODE_ORDER,DO_CHEM_LOAD_BALANCE,&
                DO_Q_CAPPING,DT_RATIO_FOR_Q_CAP,EQUIV_RATIO_CHECK,EXTINCTION_MODEL,FINITE_RATE_MIN_TEMP,FIXED_MIX_TIME,&
                FREE_BURN_TEMPERATURE,FUEL_ID_FOR_AFT,INITIAL_UNMIXED_FRACTION, MAX_CHEMISTRY_SUBSTEPS, MAX_EQUIV_RATIO, &
                MIN_EQUIV_RATIO,MIXED_ZN_TMP,N_FIXED_CHEMISTRY_SUBSTEPS, ODE_MIN_ATOL,ODE_REL_ERROR,ODE_SOLVER,SUPPRESSION,&
                TAU_CHEM,TAU_FLAME,RAMP_ZETA_0,USE_MIXED_ZN_AFT_TMP,ZZ_MIN_GLOBAL
...
IF(TRIM(ODE_SOLVER)=='CVODE') THEN
   ...
   IF(USE_MIXED_ZN_AFT_TMP) THEN
      ...
      ENDIF
   ENDIF
   AFT_ENABLE_TMP=AFT_ENABLE_TMP + TMPM ! Convert to K
   DT_RATIO_FOR_Q_CAP = MIN(1._EB,DT_RATIO_FOR_Q_CAP)
ENDIF
