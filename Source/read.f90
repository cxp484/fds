...
USE CHEMCONS, ONLY: ODE_MIN_ATOL,CVODE_ORDER,EQUIV_RATIO_CHECK, MIN_EQUIV_RATIO, MAX_EQUIV_RATIO, DO_CHEM_LOAD_BALANCE, &
                FUEL_ID_FOR_AFT,USE_MIXED_ZN_AFT_TMP,MIXING_ZN_TMP_LIMIT,CHECK_ELEMENTAL_BALANCE
REAL(EB) :: ODE_REL_ERROR
CHARACTER(LABEL_LENGTH) :: RAMP_ZETA_0='null'
NAMELIST /COMB/ CHECK_REALIZABILITY,CHECK_ELEMENTAL_BALANCE,COMPUTE_ADIABATIC_FLAME_TEMPERATURE,CVODE_ORDER,CUSTOM_TEST, &
