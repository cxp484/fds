...
NAMELIST /COMB/ CHECK_REALIZABILITY,COMPUTE_ADIABATIC_FLAME_TEMPERATURE,CVODE_ORDER,CUSTOM_TEST,CUSTOM_TEST_TYPE, &
                DO_CHEM_LOAD_BALANCE,EQUIV_RATIO_CHECK,EXTINCTION_MODEL,FINITE_RATE_MIN_TEMP,FIXED_MIX_TIME,FREE_BURN_TEMPERATURE,&
                FUEL_ID_FOR_AFT,HEAT_LOSS_FACTOR,INITIAL_UNMIXED_FRACTION,MAX_CHEMISTRY_SUBSTEPS,MAX_EQUIV_RATIO,MIN_EQUIV_RATIO,&
                MIXED_ZN_MODEL,MIXING_ZN_TMP_LIMIT,N_FIXED_CHEMISTRY_SUBSTEPS, ODE_MIN_ATOL,ODE_REL_ERROR,ODE_SOLVER, &
                RAD_LOSS_FACTOR,SUPPRESSION,TAU_CHEM,TAU_FLAME,RAMP_ZETA_0,ZZ_MIN_GLOBAL
