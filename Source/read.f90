...
USE CHEMCONS, ONLY: ODE_MIN_ATOL,CVODE_ORDER,EQUIV_RATIO_CHECK, MIN_EQUIV_RATIO, MAX_EQUIV_RATIO, DO_CHEM_LOAD_BALANCE, &
                FUEL_ID_FOR_AFT,USE_MIXED_ZN_AFT_TMP,HEAT_LOSS_FACTOR,RAD_LOSS_FACTOR,MIXING_ZN_TMP_LIMIT
...
NAMELIST /COMB/ CHECK_REALIZABILITY,COMPUTE_ADIABATIC_FLAME_TEMPERATURE,CVODE_ORDER,CUSTOM_TEST,CUSTOM_TEST_TYPE, &
                ...
                MIXING_ZN_TMP_LIMIT,N_FIXED_CHEMISTRY_SUBSTEPS, ODE_MIN_ATOL,ODE_REL_ERROR,ODE_SOLVER,RAD_LOSS_FACTOR,SUPPRESSION, &
