...
OUTPUT_QUANTITY(146)%NAME='GAS EQUILIBRIUM TEMPERATURE'
OUTPUT_QUANTITY(146)%UNITS='C'
OUTPUT_QUANTITY(146)%SHORT_NAME = 'GAS_EQ_TMP'

OUTPUT_QUANTITY(147)%NAME='INITIAL MIXED ZONE TEMPERATURE'
OUTPUT_QUANTITY(147)%UNITS='C'
OUTPUT_QUANTITY(147)%SHORT_NAME = 'IMZT'

OUTPUT_QUANTITY(148)%NAME='FINAL MIXED ZONE TEMPERATURE'
OUTPUT_QUANTITY(148)%UNITS='C'
OUTPUT_QUANTITY(148)%SHORT_NAME = 'FMZT'

OUTPUT_QUANTITY(149)%NAME='MODIFIED ZETA'
OUTPUT_QUANTITY(149)%UNITS=''
OUTPUT_QUANTITY(149)%SHORT_NAME = 'MOD_ZETA'
