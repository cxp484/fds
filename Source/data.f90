...
OUTPUT_QUANTITY(146)%NAME='ADIBABATIC FLAME TEMPERATURE'
OUTPUT_QUANTITY(146)%UNITS='C'
OUTPUT_QUANTITY(146)%SHORT_NAME = 'AFT'

OUTPUT_QUANTITY(147)%NAME='MIXED ZONE TEMPERATURE'
OUTPUT_QUANTITY(147)%UNITS='C'
OUTPUT_QUANTITY(147)%SHORT_NAME = 'MZT'
