...
INTEGER, PARAMETER :: ADSORPTION_TYPE           = 5    !< Flag for RN\%REACTYPE for SOOT
...
LOGICAL  :: ADJUST_ENERGY_FOR_MIXING_ZN = .FALSE.
...
INTEGER  :: EQUIL_WARNING_CELLS! Equilibrium warning Cell count
...
REAL(EB) :: MIXING_ZN_TMP_LIMIT = 1226.85_EB
