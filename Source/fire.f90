...
IF(ZETA_IN_MOD > ONE_M_EPS) THEN
   ...
   CALL CVODE_SERIAL(CC_CHEM_TIME,ZZ,TMP_IN_MOD,TMP_IN,DUDT,PRES_IN,ZETA0,TAU_MIX,CELL_MASS, &
   ...
   IF (CALL_CHEM_AGAIN) THEN 
      ...
      CVODE_CALL_OPTION = 1 ! CV_NORMAL
      CUR_CFD_TIME = T_CFD ! Set current cfd time in cvode, for logging purpose.
      CALL CVODE_SERIAL(CC,ZZ,TMP_IN_MOD,TMP_IN,DUDT,PRES_IN,ZETA0,TAU_MIX,CELL_MASS,&
...
CUR_CFD_TIME = T_CFD ! Set current cfd time in cvode, for logging purpose.
ZZ_IN = ZZ
CALL  CVODE_SERIAL(CC,ZZ_UNMIXED,TMP_IN_MOD,TMP_IN,DUDT,PRES_IN,ZETA0,TAU_MIX,CELL_MASS,&
                   T1,T2,GLOBAL_ODE_REL_ERROR, ATOL,TMP_OUT, CHEM_TIME, WRITE_SUBSTEPS, CVODE_CALL_OPTION)
