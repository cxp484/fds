...
ELSE
   IF (SIM_MODE .NE. DNS_MODE .AND. MIXED_ZN_TMP_MODEL .NE. CELL_TMP_MODEL) THEN
      ...
      ELSEIF (MIXED_ZN_TMP_MODEL .EQ. SOURCE_MIXZN_TMP_MODEL) THEN 
         IF (SOURCE_CELL_MIX_ZN_TMP_IN > 1000.0_EB) THEN
            CALL CALC_ADIABATIC_FLAME_TEMPERATURE(ZZ,TMP_IN,AFT)
         ELSE   
            AFT = TMP_IN
         ENDIF   
         ! AFT = MIN(SOURCE_CELL_MIX_ZN_TMP_IN,AFT)  
         !IF (SOURCE_CELL_MIX_ZN_TMP_IN > 1000) THEN
         !   WRITE(LU_ERR,*)" SOURCE_CELL_MIX_ZN_TMP_IN,TMP_IN=",SOURCE_CELL_MIX_ZN_TMP_IN,TMP_IN
         !ENDIF
      ENDIF      
