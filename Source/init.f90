...
ALLOCATE(M%TMP_MIX( -1:IBP1+1,-1:JBP1+1,-1:KBP1+1),STAT=IZERO) ; CALL ChkMemErr('INIT','TMP_MIX',IZERO) ; M%TMP_MIX = TMPA
ALLOCATE(M%TMP_MIX_OLD(-1:IBP1+1,-1:JBP1+1,-1:KBP1+1),STAT=IZERO);CALL ChkMemErr('INIT','TMP_MIX_OLD',IZERO);M%TMP_MIX_OLD=TMPA
