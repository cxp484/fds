...
ALLOCATE(M%INITIAL_TMP_MIX(-1:IBP1+1,-1:JBP1+1,-1:KBP1+1),STAT=IZERO);CALL ChkMemErr('INIT','INITIAL_TMP_MIX',IZERO);
M%INITIAL_TMP_MIX = TMPA
ALLOCATE(M%FINAL_TMP_MIX(-1:IBP1+1,-1:JBP1+1,-1:KBP1+1),STAT=IZERO);CALL ChkMemErr('INIT','FINAL_TMP_MIX',IZERO);
M%FINAL_TMP_MIX = TMPA
...
ALLOCATE(M%MOD_ZETA(0:IBP1,0:JBP1,0:KBP1),STAT=IZERO) ; CALL ChkMemErr('INIT','MOD_ZETA',IZERO) ; M%MOD_ZETA=0.0_EB
